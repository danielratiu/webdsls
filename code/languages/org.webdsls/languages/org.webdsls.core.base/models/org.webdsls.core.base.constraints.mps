...
<model ref="r:a026f70c-6507-4318-b80e-f7eedf85fadb(org.webdsls.core.base.constraints)">
  ...
  <node concept="1M2fIO" id="2ccN23ojRvd">
    <ref role="1M2myG" to="jpi:2ccN23ojRuL" resolve="IIdentifierNamedConcept" />
          ...
          <node concept="3clFbJ" id="4WLtQa9hIv3" role="3cqZAp">
            <node concept="3clFbS" id="4WLtQa9hIv4" role="3clFbx">
              <node concept="Jncv_" id="407WgdWZ89J" role="3cqZAp">
                <ref role="JncvD" to="jpi:2ccN23ojRNj" resolve="IKeywordsProvider" />
                    ...
                    <node concept="3fqX7Q" id="407WgdWZarG" role="3cqZAk">
                      <node concept="2OqwBi" id="407WgdWZaWg" role="3fr31v">
                        ...
                        <node concept="2qgKlT" id="407WgdWZbki" role="2OqNvi">
                          <ref role="37wK5l" to="xc7s:2ccN23ojROR" resolve="isKeyword" />
  ...
  <node concept="1M2fIO" id="_nvUSUbup1">
    <property role="3GE5qa" value="expressions.literals" />
    <ref role="1M2myG" to="jpi:2ccN23ohSLT" resolve="NumberLiteral" />
    <node concept="EnEH3" id="_nvUSUbup2" role="1MhHOB">
      <ref role="EomxK" to="jpi:2ccN23ohSLU" resolve="val" />
      <node concept="QB0g5" id="_nvUSUbR9G" role="QCWH9">
        <node concept="3clFbS" id="_nvUSUbR9H" role="2VODD2">
